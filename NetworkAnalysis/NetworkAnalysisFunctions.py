# requisite packages for convert_pcap_to_df, network_analysis, and network_analysis_self_cap functions
...
# network analysis function that handles own collection
def network_analysis_self_cap():
    # collect packets
    cap = sniff(count=1000)
    
    # convet pcap variable to dataframe
    df = convert_pcap_to_df(cap)
